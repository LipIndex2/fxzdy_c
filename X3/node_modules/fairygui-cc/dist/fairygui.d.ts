...
declare module 'fairygui-cc' {
    ...
    export { Frame, MovieClip } from "fairygui-cc/display/MovieClip";
...
declare module 'fairygui-cc/GLoader' {
    ...
    import { MovieClip } from "fairygui-cc/display/MovieClip";
    import { AlignType, FillMethod, FillOrigin, LoaderFillType, VertAlignType } from "fairygui-cc/FieldTypes";
    import { GComponent } from "fairygui-cc/GComponent";
    import { GObject } from "fairygui-cc/GObject";
    import { ByteBuffer } from "fairygui-cc/utils/ByteBuffer";
...
declare module 'fairygui-cc/GLoader3D' {
    import { Color, dragonBones, sp, Vec2 } from "cc";
...
declare module 'fairygui-cc/GComponent' {
    import { Constructor, Mask, Node, Vec2 } from "cc";
    import { Controller } from "fairygui-cc/Controller";
...
declare module 'fairygui-cc/GList' {
    ...
    import { AlignType, ListLayoutType, ListSelectionMode, VertAlignType } from "fairygui-cc/FieldTypes";
    import { GComponent } from "fairygui-cc/GComponent";
    import { GObject } from "fairygui-cc/GObject";
    ...
    export class GList extends GComponent {
        ...
        /**列表刷新次数 (仅虚拟列表有效)*/
        refreshTimes: number;
        /**每帧刷新item数量 (仅虚拟列表 分帧加载开启有效)*/
        preFrameCount: number;
        /**加载间隔(毫秒) (仅虚拟列表 分帧加载开启有效)*/
        loadInterval: number;
        /**是否分帧加载  (仅虚拟列表有效)*/
        isLoadInFrames: boolean;
        /**列表动效类型 (仅虚拟列表有效)*/
        effectType: number;
        /**列表动效参数 参考 GListEffectParams (仅虚拟列表有效)*/
        effectParams: {
            delay?: number,
            interval?: number,
            /**特效开始下标 (默认从刷新的第一个开始)*/
...
declare module 'fairygui-cc/PackageItem' {
    ...
    import { ObjectType, PackageItemType } from "fairygui-cc/FieldTypes";
