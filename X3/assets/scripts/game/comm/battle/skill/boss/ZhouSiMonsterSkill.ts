...
export class ZhouSiMonsterSkill3 extends FightSkillInfo {
    ...
    public skillCompleteHandler(): void {
        ...
        let P3320_x101Parm = this.skill.owner.attr.getPassiveSkillFlag(PassivitySkillFlag.P3320_x101)
        if (P3320_x101Parm)
            this.skill.owner.clearAbnormalStatus(AbnormalType.notSelect)
    }
}