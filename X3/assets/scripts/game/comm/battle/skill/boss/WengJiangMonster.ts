...
export class WengJiangMonsterSkill2 extends FightSkillInfo {
    /***开始触发行为 */
...
export class WengJiangMonsterSkill3 extends FightSkillInfo {
    /***开始触发行为 */
    public beginBehaviorEffect(behavior: SkillBehavior, owner: ICaster): void {
        super.beginBehaviorEffect(behavior, owner);
...
export class WengJiangMonsterPassivitySkill1 extends FightSkillInfo {
