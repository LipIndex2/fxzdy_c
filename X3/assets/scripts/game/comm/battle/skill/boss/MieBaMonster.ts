...
export class MieBaMonsterSkill2 extends FightSkillInfo {
...
export class MieBaMonsterSkill3 extends FightSkillInfo {
    ...
    public beginBehaviorEffect(behavior: SkillBehavior, owner: ICaster): void {
        ...
        if (param?.buff) {
            ...
            if (allUnits?.length) {
                ...
                // this.hurt(behavior, { amount: param.amount }, owner, hurtUnits)
...
export class MieBaMonsterPassivitySkill1 extends FightSkillInfo {
