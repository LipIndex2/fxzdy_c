...
import { WoErTeMonster } from "./WoErTeMonster";

export class WoErTeMonsterSkill2 extends FightSkillInfo {
    /***下次使用2技能的目标数量 */
...
export class WoErTeMonsterSkill3 extends FightSkillInfo {
    /***开始触发行为 */
    public beginBehaviorEffect(behavior: SkillBehavior, owner: WoErTeMonster): void {
        ...
        if (param?.rate) {
            ...
            if (behavior.selectUnits?.length) {
                ...
                if (P6110_x101Parm) {
                    ...
                    if (skill2 && skill2.fightSkillInfo instanceof WoErTeMonsterSkill2)
