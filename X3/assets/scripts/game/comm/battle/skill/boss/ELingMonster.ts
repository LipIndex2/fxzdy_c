...
export class ELingMonsterShow extends MonsterShowUnit {
    /***是否变身形态 */
...
export class ELingMonsterSkill2 extends FightSkillInfo {
    /***开始触发行为 */
...
export class ELingMonsterSkill3 extends FightSkillInfo {
