...
export class GangTieXiaShow extends HeroShowUnit {
    ...
    protected nodeActionComplete(aniName: string): void {
        ...
        if (aniName == "idle") {
            this.setStateHandler("idle2", true)
        }
    }
}

export class GangTieXiaSkill1 extends FightSkillInfo {
...
export class GangTieXiaSkill2 extends FightSkillInfo {
    /***开始触发行为 */
    public beginBehaviorEffect(behavior: SkillBehavior, owner: ICaster): void {
...
export class GangTieXiaSkill3 extends FightSkillInfo {
    private fightTimeCheck: FightTimeCheck
...
export class GangTieXiaPassivitySkill1 extends FightSkillInfo {
    /***开始触发行为 */
    public beginBehaviorEffect(behavior: SkillBehavior, owner: ICaster): void {
        super.beginBehaviorEffect(behavior, owner)
