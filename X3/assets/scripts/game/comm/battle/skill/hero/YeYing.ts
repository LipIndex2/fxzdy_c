...
export class YeYingSkill1 extends FightSkillInfo {
...
export class YeYingSkill2 extends FightSkillInfo {
    /***开始触发行为 */
    public beginBehaviorEffect(behavior: SkillBehavior, owner: ICaster): void {
        super.beginBehaviorEffect(behavior, owner)
...
export class YeYingPassivitySkill1 extends YeYingSkill2 {
}

export class YeYingSkill3 extends FightSkillInfo {
    private fightTimeCheck: FightTimeCheck
