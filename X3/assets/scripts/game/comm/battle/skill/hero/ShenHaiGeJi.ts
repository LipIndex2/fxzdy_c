...
/***深海歌姬 */
export class ShenHaiGeJi extends HeroUnit {
    /***2技能是否可以移动释放 */
...
export class ShenHaiGeJiSkill2 extends FightSkillInfo {
    ...
    public beginSkillHandler(): void {
        ...
        if (P6330_s203Parm) {
            (this.skill.owner as ShenHaiGeJi).canMoveSkill2 = true;
        }
    }
    ...
    public skillCompleteHandler(): void {
        (this.skill.owner as ShenHaiGeJi).canMoveSkill2 = false;
        if (this.timer)
...
export class ShenHaiGeJiSkill3 extends FightSkillInfo {
    public timer: FightTimeLoop
    /***开始触发行为 */
    public beginBehaviorEffect(behavior: SkillBehavior, owner: ICaster): void {
        super.beginBehaviorEffect(behavior, owner)
