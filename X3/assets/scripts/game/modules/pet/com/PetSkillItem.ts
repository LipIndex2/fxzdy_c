...
/** 宠物技能item */
@bindFguiExtension("ui://pet/PetSkillItem")
export class PetSkillItem extends fgui.GComponent {
    static pkgName: string = "pet";
    static viewName: string = "PetSkillItem";
    ...
    protected onInit() {
        this.view.on(fgui.Event.CLICK, this.previewSkill, this);
    ...
    previewSkill() {
        ...
        if (this._groupId)
            G.UIManager.open(UIHeroKey.SkillInfoWin, { groupId: this._groupId, data: this._skillData, petCfgId: this._petCfgId } as SkillInfoWinOpenArgs)
