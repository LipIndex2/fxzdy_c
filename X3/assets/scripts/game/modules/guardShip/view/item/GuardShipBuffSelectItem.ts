...
@bindFguiExtension('ui://guardShip/GuardShipBuffSelectItem')
export class GuardShipBuffSelectItem extends fgui.GButton {

    static pkgName: string = "guardShip";
    static viewName: string = "GuardShipBuffSelectItem";

    /**当前品质*/
    protected _quality: number = 0

    private get view(): ui.guardShip.item.GuardShipBuffSelectItem {
        return this as any;
    }
    ...
    public setData(buffId: number): void {
        let cfg = G.TableManager.getDataById(table.guardship.GuardShipSkillConfig, buffId)
