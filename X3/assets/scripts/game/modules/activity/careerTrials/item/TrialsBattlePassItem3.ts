 ...
 * 大奖励item
 */
@bindFguiExtension("ui://activityCareerTrials/TrialsBattlePassItem3")
export class TrialsBattlePassItem3 extends fgui.GComponent {
    ...
    static viewName: string = "TrialsBattlePassItem3";

    private get view(): ui.activityCareerTrials.item.TrialsBattlePassItem3 {
        return this as any;
    }
