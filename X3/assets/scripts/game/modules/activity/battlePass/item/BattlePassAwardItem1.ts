...
/** 通行证 奖励item */
export class BattlePassAwardItem1 extends fgui.GComponent {
    ...
    static viewName: string = "BattlePassAwardItem1";

    private get view(): ui.activityBattlePass.item.BattlePassAwardItem1 {
        return this as any;
    }
