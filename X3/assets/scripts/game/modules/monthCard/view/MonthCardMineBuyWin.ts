 ...
 * 终身卡界面
 */
@bindScript(UIMonthCardConfig.MonthCardMineBuyWin)
export class MonthCardMineBuyWin extends UICommWin {

    static pkgName: string = "activityPass";
    static viewName: string = "MonthCardMineBuyWin";

    protected _cardData: MonthCardData = null;
    protected _descList: MonthCardAdditionDesc[] = []

    private get view(): ui.activityPass.monthCard.view.MonthCardMineBuyWin {
