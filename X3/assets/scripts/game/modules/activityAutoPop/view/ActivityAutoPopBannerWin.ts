 ...
 * 活动冲榜banner弹框
 */
@bindScript(UIActivityAutoPopConfig.ActivityAutoPopBannerWin)
export class ActivityAutoPopBannerWin extends UICommWin {
    static pkgName: string = "activityAutoPop";
    static viewName: string = "ActivityAutoPopBannerWin";
    ...
    private get view(): ui.activityAutoPop.view.ActivityAutoPopBannerWin {
