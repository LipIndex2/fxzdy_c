 ...
 * STK女团banner弹框
 */
@bindScript(UIActivityAutoPopConfig.ActivityAutoPopSTKWin)
export class ActivityAutoPopSTKWin extends UICommWin {
    static pkgName: string = "activityAutoPop";
    static viewName: string = "ActivityAutoPopSTKWin";
    ...
    private get view(): ui.activityAutoPop.view.ActivityAutoPopSTKWin {
