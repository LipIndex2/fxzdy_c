export class SortUtils {
     ...
     * 
     */
    public static sortBy2(_arr1: any[], p: any[], reArr: boolean[] = [], isNew: boolean = true): any[] {
        var arr: any[] = isNew ? _arr1.concat() : _arr1;
        arr.sort(sortFun);
        return arr;
     ...
     *  isNew 是否创建新的数组
     */
    public static sortBy3(_arr1: any[], _arr2: any[], reArr: any[], isNew: boolean = true): any[] {
        var arr: any[] = isNew ? _arr1.concat() : _arr1;
