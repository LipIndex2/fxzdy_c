...
export class LayaByte {
    ...
    static getSystemEndian(): string {
        if (!LayaByte._sysEndian) {
            var buffer: any = new ArrayBuffer(2);
            new DataView(buffer).setInt16(0, 256, true);
            LayaByte._sysEndian = (new Int16Array(buffer))[0] === 256 ? LayaByte.LITTLE_ENDIAN : LayaByte.BIG_ENDIAN;
        }
        return LayaByte._sysEndian;
    }
     ...
     */
    get endian(): string {
        return this._xd_ ? LayaByte.LITTLE_ENDIAN : LayaByte.BIG_ENDIAN;
    }

    set endian(value: string) {
        this._xd_ = (value === LayaByte.LITTLE_ENDIAN);
    }
