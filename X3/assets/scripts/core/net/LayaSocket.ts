 ...
 */
export class LayaSocket extends EventTarget {
    /**
     ...
     * @see laya.utils.Byte
     */
    constructor(serverAddr: string | null = null, byteClass: new () => any = null, protocols: any[] | null = null) {
        super();
        this._byteClass = byteClass ? byteClass : LayaByte;
        this.protocols = protocols;
        this.endian = LayaSocket.BIG_ENDIAN;
        serverAddr && this.connect(serverAddr);
    }
    ...
    protected _onMessage(msg: any): void {
        ...
        if (this.disableInput && data) {
            this.emit(LayaEvent.MESSAGE, data);
            return;
        }
    ...
    flush(): void {
        if (this._output && this._output.length > 0) {
            ...
            this._output.endian = this.endian;
            this._output.clear();
            if (evt) this.emit(LayaEvent.ERROR, evt);
        }
    }
}
